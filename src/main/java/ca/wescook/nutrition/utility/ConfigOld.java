...
////		ConfigOld.configDirectory = configDirectory;
//
...
//
//		logMissingFood = configFile.getBoolean("LogMissingFood", CATEGORY_LOGGING, false, "Log foods which have defined nutrients but aren't found in-game.");
//		logMissingNutrients = configFile.getBoolean("LogMissingNutrients", CATEGORY_LOGGING, false, "Log foods which exist but do not have any associated nutrients.");
//
//		// Update file
